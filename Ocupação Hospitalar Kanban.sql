select distinct
  ...
  obter_se_maior_limite_sus(a.nr_atendimento, obter_qt_dia_internacao_sus(d.cd_procedimento, d.ie_origem_proced))kanban_cru,
...
where 
  ...
  AND (obter_se_maior_limite_sus(a.nr_atendimento, obter_qt_dia_internacao_sus(d.cd_procedimento, d.ie_origem_proced)) =:kanban OR NVL(:kanban,0) = 'todos')
