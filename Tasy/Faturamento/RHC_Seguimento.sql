select	
  ...
  a.CD_RAZAO_NAO_TRAT ||';'||
  CASE NVL(x.IE_PROCED_TERAP_NENHUM,a.IE_TRAT_INSTITUICAO) WHEN 'S' THEN 1 ELSE 0 END ||';'||
  ...
  CASE NVL(x.IE_NENHUM_ANT, a.IE_NENHUM_ANT) WHEN 'S' THEN 1 ELSE 0 END ||';'||
  ...
  CASE NVL(x.IE_NENHUM_AP, a.IE_NENHUM_AP) WHEN 'S' THEN 1 ELSE 0 END ||';'||
